...
## Identity
- **Name:** Zero
- **Species:** Changeling (Fey creature type)
- **Class:** Bard
...
## Skills
*(P = proficient, E = expertise, J = Jack of All Trades only)*

| Skill | Ability | Prof | Total |
|---|---|---|---|
| Acrobatics | DEX | P | +5 |
...
### Cantrips
- Vicious Mockery (Save: WIS DC 13 | 1A | 60 ft. | V | Instant)
- Mage Hand (1A | 30 ft. | V,S | 1 minute)
...
### 2nd Level
- Invisibility (1A | Touch | V,S,M | Concentration, 1 hour)
- Suggestion (Save: WIS DC 13 | 1A | 30 ft. | V,M | Concentration, 8 hours)
